...
<div class="row gutters">
						...
						<div class="col-xl-6 col-lg-6 col-md-6 col-sm-12 col-12">
							<div class="card">
								...
								<div class="card-body">
                                    <form action="<?php echo BASE_URL?>/user/update" method="POST" id="form_category">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <option value="Active" <?php if($data['data']['is_admin']=="Active") { echo 'selected'; }?>>Active</option>  
                                        <option value="InActive" <?php if($data['data']['is_admin']=="InActive") { echo 'selected'; }?>>InActive</option>    
                                    </select>
                                    <div class="form-group">
                                        ...
                                        <option value="0"<?php if($data['data']['is_admin']==0) { echo 'selected'; }?>>No</option>  
                                        <option value="1" <?php if($data['data']['is_admin']==1) { echo 'selected'; }?>>Yes</option>    
                                    </select>
									</div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input name="id" type="hidden" value="<?php echo isset($data['data']['id'])? $data['data']['id']:""; ?>">
									</div>
