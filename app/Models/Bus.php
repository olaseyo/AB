...
class Bus extends Model{
    ...
    public function getAvailableBus($id){
        return $this->database->getRow("SELECT * FROM ".$this->table." where busy=0 and id=$id");
    }

    public function getAvailableBuses(){
        return $this->database->getResults("SELECT * FROM ".$this->table." where busy=0");
    }
